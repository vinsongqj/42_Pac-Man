...
from client.gamemode import GameMode
...
class GameState:
    ...
    # change gamestate to only monitor logic. move all graphical related stuff to graphics class
    def __init__(self, size: tuple[int, int] = (21, 21)) -> None:
        self.size = size
        self.level_number = 0
        self.level: Maze
        self.gamemode: GameMode  # ENUM: Scatter, Chase, Frightened
